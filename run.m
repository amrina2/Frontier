...
sigma = 5 ; %Prior uncertainty which is changable and is the reason of having different priori covariance.
theta = 1; % This theta is a parameter of the priori covariance. 
K=1; % Number of iteration that we want. This is also changable. 
%%%%
